...
HD_PWD='C:/Users/rgaas/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FPGA_TopLevel.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FPGA_TopLevel.tcl
