...
HD_PWD='C:/Users/rgaas/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log FPGA_TopLevel.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source FPGA_TopLevel.tcl -notrace
